...
from seq_rec.params import MODEL_NAME

if TYPE_CHECKING:
    import bentoml
    from lightning import Trainer

    from seq_rec.lightning import MatrixFactorizationLitModule
...
def prepare_trainer(
    ...
    from seq_rec.lightning import cli_main
...
def test_queries() -> None:
    ...
    from seq_rec.bentoml.service import (
        EXAMPLE_ITEM,
        EXAMPLE_USER,
        ItemCandidate,
        ItemQuery,
